...
export default function PeripheralsCombo() {
  ...
  function handleFormChange(field, value) {
    if (field === "action") {
      ...
      setFormData((prev) => ({ ...prev, action: value, badge: statusInfo?.badge || "null" }));
      return;
    }
      ...
      {loading ? (
        ...
        <>
          <div className="combo-topbar">
            <h1 className="combo-title">Combo</h1>
            ...
            <div className="combo-topbar-right">
              ...
              <CsvToolsBar
                isAdmin={isAdmin}
                exportFileName="comboAssets"
                data={assets}
                onImport={async (rows) => {
                  const created = await comboAssetService.bulkImport(rows);
                  setAssets((prev) => [...prev, ...created]);
                }}
              />
            </div>
