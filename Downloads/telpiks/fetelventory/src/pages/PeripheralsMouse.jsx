...
import { mouseAssetService, MOUSE_STATUSES } from "../services/mouseAssetService";
...
export default function PeripheralsMouse() {
  ...
  function handleFormChange(field, value) {
    if (field === "action") {
      const statusInfo = MOUSE_STATUSES.find((s) => s.value === value);
        ...
        <>
          <div className="ms-topbar">
            ...
            <div className="ms-topbar-right">
              <div className="ms-summary-card ms-summary-yellow stagger-item">
                <span className="ms-summary-label">Total Stock</span>
                <span className="ms-summary-value">{totalStock} Unit</span>
              </div>

              <div className="ms-summary-card ms-summary-green stagger-item">
                <span className="ms-summary-label">In Use</span>
                <span className="ms-summary-value">{inUse} Unit</span>
              </div>

              <div className="ms-summary-card ms-summary-blue stagger-item">
                <span className="ms-summary-label">In Store</span>
                <span className="ms-summary-value">{inStore} Unit</span>
              </div>
              ...
              <CsvToolsBar
                isAdmin={isAdmin}
                exportFileName="mouseAssets"
                data={assets}
                onImport={async (rows) => {
                  const created = await mouseAssetService.bulkImport(rows);
                  setAssets((prev) => [...prev, ...created]);
                }}
              />
            </div>
          ...
          <section className="ms-section stagger-item">
