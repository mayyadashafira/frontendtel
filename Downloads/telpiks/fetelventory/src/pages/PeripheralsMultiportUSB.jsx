        ...
        <>
          <div className="usb-topbar">
            ...
            <div className="usb-topbar-right">
              ...
              <CsvToolsBar
                isAdmin={isAdmin}
                exportFileName="multiportUsbAssets"
                data={assets}
                onImport={async (rows) => {
                  const created = await multiportUsbAssetService.bulkImport(rows);
                  setAssets((prev) => [...prev, ...created]);
                }}
              />
            </div>
          ...
          <section className="usb-section stagger-item">
