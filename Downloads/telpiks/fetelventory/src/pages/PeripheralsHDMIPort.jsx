...
import { Plug, Plus, Eye, Pencil, Trash2, ImagePlus } from "lucide-react";
      ...
      {loading ? (
        ...
        <>
          <div className="hdmi-topbar">
            <h1 className="hdmi-title">High-Definition
            <br/>Multimedia Interface
            <br/>(HDMI) Port</h1>
            ...
            <div className="hdmi-topbar-right">
              ...
              <CsvToolsBar
                isAdmin={isAdmin}
                exportFileName="hdmiPortAssets"
                data={assets}
                onImport={async (rows) => {
                  const created = await hdmiPortAssetService.bulkImport(rows);
                  setAssets((prev) => [...prev, ...created]);
                }}
              />
            </div>
          ...
          <section className="hdmi-section stagger-item">
            <h2 className="hdmi-section-title">
              <Plug size={22} />
              Master Tabel Data High-Definition Multimedia Interface (HDMI) Port
            </h2>
